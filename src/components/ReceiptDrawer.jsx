...
const ReceiptDrawer = ({ order, onClose, onUpdatePayment }) => {
  ...
  return (
    <Sheet open={!!order} onOpenChange={onClose}>
      <SheetContent side="right" className="w-full sm:max-w-md p-6 animate-slide-in-from-right">
        <SheetHeader>
        ...
        <div className="text-sm text-muted-foreground space-y-1 mt-4">
          ...
          <div>Manager:                   <div 
                    className="inline-block px-2 py-1 rounded text-sm font-semibold mt-1"
                    style={getManagerBadgeStyle(order.registerSession.manager)}
                  >
                    {order.registerSession.manager}
                  </div></div>
        ...
        <div className="border-t pt-2 text-sm space-y-1 mt-4">
          <div className="flex justify-between">
            <span>Discount</span>
