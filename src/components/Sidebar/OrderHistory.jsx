...
const OrdersHistory = ({ onUpdatePayment, fetchAllOrders, allOrders, isLoadingAllOrders }) => {
  ...
  }, [fetchAllOrders, allOrders.length]); // Only depend on fetchAllOrders and length
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">PKR {(order.finalPrice || 0).toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between">
                            <span>Amount Paid:</span>
                            <span className="text-green-600">PKR {(order.amountPaid || 0).toLocaleString()}</span>
                          </div>
                          <div className="flex justify-between">
