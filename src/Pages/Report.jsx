...
const Report = () => {
  ...
  const updateDocumentMeta = (startDate, endDate) => {
    ...
    document.title = "Cartel Burgers - Report Dashboard";
    ...
    if (ogTitle) {
      ogTitle.setAttribute('content', "Cartel Burgers's - Report Dashboard");
    } else {
      const newOgTitle = document.createElement('meta');
      newOgTitle.setAttribute('property', 'og:title');
      newOgTitle.content = "Cartel Burgers's - Report Dashboard";
    ...
    if (twitterTitle) {
      twitterTitle.setAttribute('content', "Cartel Burgers's - Report Dashboard");
    } else {
      const newTwitterTitle = document.createElement('meta');
      newTwitterTitle.name = 'twitter:title';
      newTwitterTitle.content = "Cartel Burgers's - Report Dashboard";
  ...
  const restoreOriginalMeta = () => {
    ...
    document.title = "Cartel Burgers's";
    
    // Restore original meta description (you can customize this)
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', "Cartel Burgers's - Premium Waffles & Delicious Treats");
    }
  };
        ...
        <div className="container mx-auto px-4 py-6 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6 print:break-inside-avoid">
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <div className="text-center">
                <h1 className="text-2xl font-bold text-gray-900">Cartel Burgers's Report</h1>
